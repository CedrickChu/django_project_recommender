...
CREATE TABLE `project_app_employeetraining` (
  ...
  KEY `project_app_employeetraining_employee_id_957cf520` (`employee_id`),
  ...
  CONSTRAINT `project_app_employee_training_id_fe6f080f_fk_project_a` FOREIGN KEY (`training_id`) REFERENCES `project_app_training` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project_app_training` (
  ...
  `idtrainings` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idtrainings` (`idtrainings`),
  KEY `project_app_training_institution_id_02eda21f_fk_project_a` (`institution_id`),
  CONSTRAINT `project_app_training_institution_id_02eda21f_fk_project_a` FOREIGN KEY (`institution_id`) REFERENCES `project_app_institution` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-12-09 19:01:32

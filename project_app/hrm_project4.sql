...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$720000$lQHL87nWtvjroUbRYqE5kf$k+AYB7UqMVZz6e1zXotn5n4cQUxpZh/bN4DKOUMYhGU=','2023-12-13 14:10:27.289346',1,'admin','','','admin@gmail.com',1,1,'2023-12-09 08:16:05.278223');
...
INSERT INTO `django_admin_log` VALUES (1,'2023-12-10 04:36:19.103798','9','Hiking',1,'[{\"added\": {}}]',7,1),(2,'2023-12-10 04:36:23.695786','10','Video Game',1,'[{\"added\": {}}]',7,1),(3,'2023-12-10 04:36:28.647558','11','Volunteering',1,'[{\"added\": {}}]',7,1),(4,'2023-12-10 04:36:34.639876','12','Dancing',1,'[{\"added\": {}}]',7,1),(5,'2023-12-10 04:36:41.895448','13','Singing',1,'[{\"added\": {}}]',7,1),(6,'2023-12-10 05:39:35.654631','139','Charls Brent Cayabyab - Back-End Web Developer - Average',1,'[{\"added\": {}}]',16,1),(7,'2023-12-10 05:39:53.532375','139','Charls Brent Cayabyab - Back-End Web Developer - In Person Training',2,'[{\"changed\": {\"fields\": [\"Participation type\"]}}]',16,1),(8,'2023-12-10 06:09:34.286491','62','John Cedrick Chu',2,'[{\"changed\": {\"fields\": [\"Personality\", \"Institution\"]}}]',12,1),(9,'2023-12-10 06:10:26.608633','166','Carljay Almojuela - The Inspector - ISTJ',1,'[{\"added\": {}}]',10,1),(10,'2023-12-10 06:10:46.372705','166','Carljay Almojuela - The Inspector - ISTJ',3,'',10,1),(11,'2023-12-10 06:11:37.965088','167','John Cedrick Chu - The Supervisor - ESTJ',1,'[{\"added\": {}}]',10,1),(12,'2023-12-10 06:11:50.279532','62','John Cedrick Chu - The Mastermind - INTJ',3,'',10,1),(13,'2023-12-10 06:13:15.796107','166','Jose Chan',1,'[{\"added\": {}}]',12,1),(14,'2023-12-10 06:52:27.810561','166','Jose Chan',2,'[{\"changed\": {\"fields\": [\"Personality\"]}}]',12,1),(15,'2023-12-13 17:37:05.447780','757','Al-nizar Wahab - Art',3,'',9,1),(16,'2023-12-13 17:37:05.463827','756','Al-nizar Wahab - Gaming',3,'',9,1),(17,'2023-12-13 17:37:05.467838','755','Al-nizar Wahab - Cooking',3,'',9,1),(18,'2023-12-13 17:37:05.472700','754','Al-nizar Wahab - Travel',3,'',9,1),(19,'2023-12-13 17:37:05.476822','753','Al-nizar Wahab - Music',3,'',9,1),(20,'2023-12-13 17:37:05.479691','752','Al-nizar Wahab - Sports',3,'',9,1),(21,'2023-12-13 17:37:05.483681','751','Al-nizar Wahab - Reading',3,'',9,1),(22,'2023-12-13 17:38:07.226649','759','Marvin Esmeralda - Fitness',3,'',9,1);
...
INSERT INTO `django_session` VALUES ('lle125oil300a9lk3zk3sym2ykv8hd48','.eJxVjDsOwjAQBe_iGlnxdzElPWeIdr1rHECOlE-FuDuylALaNzPvrUbctzruqyzjxOqijDr9boT5Ka0DfmC7zzrPbVsm0l3RB131bWZ5XQ_376DiWns9IABbNtlmgMglgSQXS_TnQMQhiQPrM5sSAwZLNgxOMhaiwTvjRX2-72w4MQ:1rDPwR:kvot_Mr13f2ppIEJcB-lb6jNGQXBmY58MtwMPslc7ho','2023-12-27 14:10:27.293110'),('yf1cmss6gtvsoizwmyl7z9rukgotkhsx','.eJxVjMsOgjAQRf-la9NQkGHq0j3fQOZVixpIKKyM_64kLHR7zzn35Qba1jxsxZZhVHdxwZ1-NyZ52LQDvdN0m73M07qM7HfFH7T4flZ7Xg_37yBTyd-aFbqOOwCUBo2wYkBDrDAm0mBijahULdRyDsAxtJQio4AlTZJqce8P9wQ5Dg:1rBsXm:8PoerDt5YjWGNr0wNTGULMskRUALVysZmmqmz7CzIcM','2023-12-23 08:18:38.319325');
...
CREATE TABLE `project_app_employeehobby` (
  ...
  CONSTRAINT `fk_hobbies` FOREIGN KEY (`hobby_id`) REFERENCES `project_app_hobby` (`id`),
...
CREATE TABLE `project_app_employeeskills` (
  ...
  KEY `project_app_employeeskills_employee_id_1e1cd70c` (`employee_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `project_app_employeeskills` VALUES (1,3,'Advanced Mastery'),(2,14,'Average'),(3,51,'Advanced'),(4,18,'Advanced'),(4,71,'Beginner'),(6,6,'Intermediate'),(7,9,'Beginner'),(8,10,'Beginner'),(9,11,'Mid-level'),(11,0,'Advanced'),(12,16,'Professional'),(13,13,'Expert'),(14,118,'Professional'),(15,17,'Intermediate'),(16,8,'Expert'),(17,117,'Professional'),(18,56,'Average'),(19,20,'Average'),(20,45,'Advanced Mastery'),(21,23,'Expert'),(22,16,'Amateur'),(23,21,'Expert'),(24,25,'Expert'),(25,26,'Expert'),(26,88,'Professional'),(27,32,'Professional'),(28,23,'Beginner'),(29,57,'Professional'),(30,79,'Professional'),(31,28,'Legendary'),(32,36,'Professional'),(33,33,'Professional'),(34,102,'Advanced'),(35,12,'Beginner'),(35,105,'Professional'),(36,35,'Expert'),(37,14,'Intermediate'),(38,22,'Professional'),(39,11,'Amateur'),(40,66,'Average'),(41,123,'Professional'),(42,50,'Intermediate'),(43,55,'Average'),(44,123,'Expert'),(45,63,'Expert'),(46,125,'Proffesional'),(47,69,'Intermediate'),(48,51,'Professional'),(49,23,'Advanced'),(50,88,'Expert'),(51,98,'Master Level'),(52,99,'Beginner'),(53,64,'Professional'),(54,87,'Ibang Level'),(55,51,'Professional'),(56,24,'Intermediate'),(57,106,'Intermediate  '),(58,111,'Professional'),(59,124,'Professional'),(60,112,'Intermediate'),(61,15,'Intermediate'),(62,81,'Advanced Mastery'),(63,87,'Professional'),(64,103,'Professional'),(65,32,'Professional'),(66,55,'Intermediate'),(67,39,'Professional'),(68,11,'Advance Mastery'),(69,123,'Ace'),(70,18,'Professional'),(71,4,'Professional'),(72,71,'Professional'),(73,37,'Non Professional'),(74,81,'Professional'),(75,1,'Professonal'),(76,22,'Professional'),(77,51,'Advanced 2'),(78,0,'Professional'),(79,1,'Beginner'),(80,5,'Mythical Glory'),(81,32,'Professional'),(82,33,'Entry Level'),(83,23,'Professional'),(84,27,'Professional'),(85,28,'Professional'),(86,95,'Professional'),(87,16,'Professional'),(88,84,'Advanced'),(89,78,'Professional'),(90,12,'Professional'),(91,89,'Advance'),(92,41,'Average'),(93,85,'Entry-level'),(94,41,'Professional'),(95,123,'Professional'),(96,98,'LEVEL 1'),(97,41,'High'),(98,14,'Newbie'),(99,18,'Professional'),(100,98,'SUPER SAIYAN'),(101,81,'Amateur'),(102,123,'Average'),(103,75,'Professional'),(104,113,'Average'),(105,117,'Average'),(106,74,'Professional'),(107,23,'Average'),(108,11,'Advanced'),(109,133,'Amateur'),(110,48,'Professional'),(111,38,'Advanced'),(112,56,'Amateur'),(113,75,'Professional'),(114,145,'Amateur'),(115,160,'Advanced'),(116,133,'Professional'),(117,42,'Amateur'),(118,51,'Advanced'),(119,46,'Master Level'),(120,86,'Professional'),(121,123,'Advanced'),(122,132,'Advanced'),(123,128,'Professional'),(124,19,'Master Level'),(125,66,'Advanced'),(126,51,'Advanced'),(127,64,'Amateur'),(128,75,'Professional'),(129,53,'Professional'),(130,57,'Professional'),(131,17,'Amateur'),(132,41,'Amateur'),(133,32,'Intermediate'),(134,37,'Professional'),(135,39,'Advanced'),(136,40,'Advanced'),(137,30,'Professional'),(138,10,'Intermediate'),(139,11,'Beginner'),(140,44,'Beginner'),(141,43,'Advance Mastery'),(142,67,'Intermediate'),(143,13,'Professional'),(144,85,'Advanced'),(145,16,'Professional'),(146,16,'Intermediate'),(147,23,'Amateur'),(148,67,'Master Level'),(149,16,'Amateur'),(150,23,'Beginner'),(151,74,'Professional'),(152,12,'Master Level'),(153,78,'Master Level'),(154,155,'Professional'),(155,133,'Master Level'),(156,132,'Professional'),(157,142,'Advanced'),(158,112,'Amateur'),(159,132,'Intermediate'),(160,178,'Intermediate'),(161,51,'Amateur'),(162,122,'Advanced'),(163,149,'Amateur'),(164,85,'Advanced'),(165,92,'Beginner'),(166,116,'Advanced');
...
INSERT INTO `project_app_skill` VALUES (0,'Web Design','encompasses many different skills and discipl'),(1,'Quantum Code','Quantum coding involves programming at the in'),(2,'','Skills in database design, SQL (Structured Qu'),(3,'Programming','Understanding of algorithms, data structures,'),(4,'Cloud Computing','Familiarity with cloud platforms like AWS (Am'),(5,'Information Architecture','Information architecture (IA) involves effect'),(6,'Web Development',' Create and maintain websites.'),(7,'Cybersecurity','Businesses need people with cybersecurity ski'),(8,'Analytical Skills','Ability to gather, interpret, and analyze dat'),(9,'Managing','Manages and oversees IT projects'),(10,'Mathematical Reasoning','The process of applying logical thinking to a'),(11,'Technical Proficiency','Understanding of networking protocols, operating systems, and security technologies to analyze logs, identify vulnerabilities, and troubleshoot issues.'),(12,'Critical Thingkings','Critical thinking is the intellectually disci'),(13,'Front End Engineering','A front-end engineer works on the part of the'),(14,'Networking','Knowledge of networking protocols, infrastruc'),(16,'UI/UX Design','Understanding user interface design principle'),(17,'Artificial Intelligence','Technical and Non-Technical abilities to depl'),(18,'Mobile app development','Mobile app development is the process of crea'),(19,'Cloud Engineering',' builds and maintains cloud infrastructure'),(20,' Technical Analysts','Configure and implement SaaS solutions'),(21,'Back End Developer','A back-end developer possesses expertise in s'),(22,'Full-Stack Development','Full stack development refers to the end-to-e'),(23,'UI Design','UI (User Interface) design focuses on creatin'),(24,'Analytics and Troubleshooting','a logical process network engineers follow to'),(25,'Analytical Abilities','Being Analytical gives you a major edge in IT'),(26,'Artificial Intelligence','deep learning, reinforcement learning, comput'),(27,'Communication','Strong communication skills ensure that your '),(28,'Troubleshooting and Technical Support','Strong troubleshooting skills for identifying'),(29,'Web Developer','A Web Developer is a professional who is resp'),(30,'Penetration Tester','Penetration testers, also known as pen tester'),(31,'Service Management','Wrapping technologies in services that are di'),(32,'Game Development','encompassing technical, creative, and collabo'),(33,'Web Developer','Expertise with modern web programming languag'),(34,'Technical','Java programming'),(35,'Data visualization','presenting complex data in a graphical or vis'),(36,'Visual effects','Visual effects (sometimes abbreviated VFX) is'),(37,'Visualize and Conceptualize Information','The ability to conceptualize and visualize in'),(38,'Graphics Design Specialist','crafts visually compelling and impactful digital designs, leveraging creative expertise and technical skills to produce engaging visuals across various mediums.'),(39,'Technical Support','Technical support (tech support) refers to a range services companies provide to their customers for products such as software, mobile phones, printers, and other electronic, mechanical or electromechanical products.'),(40,'Risk Assessment','Capability to assess and manage risks associa'),(41,'Excellent Designing','Ability to provide beautiful designs and enha'),(42,'Cloud Platform Proficiency','Ability to proficiently navigate and leverage'),(43,'Implementation of backup and recovery process','Minimize the risk of data loss and ensure tha'),(44,'IT Infrastructure and Systems Administration','IT Infrastructure Configuring and Maintenance'),(45,'Programming','programming is that it is a way of providing '),(46,'Business Intelligence','Skilled in gathering and analyzing business d'),(47,'Vulnerability Management','Identifying and addressing vulnerabilities in'),(48,'Data Analyst','Creating Dashboards and Reports'),(49,'Web Designer','The skill description for a web designer typi'),(50,'Debugging','Evaluating and debugging modules'),(51,'photographic log and photographic sketch','Photograph all latent fingerprints and other '),(52,'Full Stack Developer','Knowledgeable in every aspect of programming'),(53,'Valorant Pro','Gaming and Line Up'),(54,'Handy Man','Full-Stack HandyMan'),(55,'Web Design','Creating user friendly designs for websites.'),(56,'Geographic Information System (GIS) Specialis','GIS specialists utilize geospatial data to cr'),(57,'Project Management','Overseeing and managing IT projects from init'),(58,'esports coach','work closely with the players, to motivate th'),(59,'Data Harmonization','Harmonize data for unified insights'),(60,'Ethical Decision-Making','Ethical decision-making involves the process of evaluating and choosing actions that align with moral principles and values. It requires considering the potential impact of decisions on various stakeholders, adhering to principles of fairness, honesty, and integrity, and ensuring that choices uphold ethical standards and legal requirements. Ethical decision-making guides individuals and organizations to make choices that contribute to the well-being of society and promote trust and credibility.'),(63,'Artificial Intelligence (AI)','Proficient in developing AI models using mach'),(64,'Software and Hardware Knowledge','Understanding of computer hardware and famili'),(65,'Problem Solving Skills','Ability to solve problems effectively'),(66,'Programming','Capable of developing efficient and scalable '),(67,'Data Analyst','Data analysis tools assist you in uncovering '),(68,'Game Analyst','Examine games to ensure they are free of bugs'),(69,'Ethical Hacking',' security experts that perform these security'),(70,'Networking','Cisco CCNA'),(71,'Cybersecurity','Ethical Hacking'),(72,'Data Science','Python and Pandas'),(73,'IT Policy Development','Crafts effective IT policies, aligning industry standards, legal requirements, and organizational needs.'),(74,'Strategic Planning','ligns IT policy initiatives with organizational goals, anticipates future needs, and adapts policies to evolving technology.'),(75,'Full Stack Developer','Full-stack developers possess a diverse skill'),(76,'Graphic Design','Deisgn a website'),(77,'Graphic Design','Proficiency in Adobe Creative Suite or other '),(78,'Machine Learning','This area involves creating and refining algo'),(79,' Statistical Analysis','Understanding statistical tests and tools is crucial. Familiarity with mean, median, variance, standard deviation, correlation, regression, and hypothesis testing can be fundamental.'),(80,'Computer Analyst','computer virus killer'),(81,'Cloud Network Engineer ','design and implement computer and information'),(82,'Information Systems Analyst',' uses analysis and design techniques to solve business problems using information technology.'),(83,'data analysis and management','These skills allow DPOs to effectively overse'),(84,'Cloud Engineer','cloud computing,  maintenance and support'),(85,'Technical Support','Technical Trouble shooting and customer suppo'),(86,'IT developer','Installing Firewalls and routers'),(87,'Data Visualization','Alongside basic knowledge of spreadsheets, ha'),(88,'game design','Develop and maintain graphics applications'),(89,'Solve design challenges creatively','Design digital interfaces'),(90,'Computer maintenance','Keeping your computers and laptops in good co'),(91,'Competitive Programming','A sport where contestants solve algorithmic p'),(92,'Software Engineering','Developing Website for Needs'),(93,'Cybersecurity','Knowledge of security principles'),(94,'QA Engineer ','Find and fix bugs'),(95,'Graphic Design','Designing application'),(96,'Programming','full-stack dev'),(97,'Software Engineering','Develop and maintain software applications'),(98,'Basic Web Designer','Plan, create and code internet sites and web pages, many of which combine text with sounds, pictures, graphics and video clips. A web designer is responsible for creating the design and layout of a website or web pages.'),(99,'Operating Systems','Troubleshooting'),(100,'Coding','Software architecture understanding and desig'),(101,'Professional Gamer','Competitive gamer '),(102,'Help Desk Support, Database, MS Office, Activ','Identify and troubleshoot networked systems. '),(103,'Web Design','Making a user-friendly websites'),(104,'Problem-Solving Aptitude','possesses a strong problem-solving aptitude, '),(105,'Cipher Text  Decoder','Encrypted to Decrypted text decoder'),(106,'Algorithm Design and Analysis','Proficient problem-solving skills to understa'),(107,'Data Mining','searching and analyzing a large batch of raw '),(108,'Database management',' responsible for developing and maintaining a'),(109,'DevOps Design','Develop programs and design manually'),(110,'Graphic Design','Designing application'),(111,'Algorithm and Data Structures','Understanding and implementing efficient algo'),(112,'Neural Network Architect','Design efficient and effective neural network'),(113,'Data analytics developer','Clarify & set business expectations'),(114,'GameDevs Design','Develop games and design manually'),(115,'Floor General','coach on the floor, and the heart of the team'),(116,'Creativity','The ability to generate original ideas, characters, and stories is fundamental in animation. Creativity fuels the entire process of bringing imagination to life.'),(117,'Web Developer','Mastered in HTML,CSS, and JS'),(118,'Front-End Web Developer','Designing Front-end of websites.'),(119,'Cybersecurity','is the application of technologies, processes'),(120,'DevOps','Combination of “development” and “operations”'),(121,'Web Design','encompasses many different skills and discipl'),(122,'Scripting and Code Efficiency','Writing scripts to automate repetitive tasks '),(123,'Operating Systems','Troubleshooting'),(124,'Minning Strat','Data Analysis'),(125,'FASTER ENCODER','FASTING TYPING'),(126,'Automation','Scripting and automation skills for routine tasks (e.g., Bash, PowerShell).'),(127,'Augmented Reality Development','Proficiency in AR frameworks, platforms, and '),(128,'Bogaboga developer','Bogaboga'),(129,'Web Design','encompasses many different skills and discipl'),(130,'Risk Taker','Expert in Risk Analyzing'),(131,'Web Design','encompasses many different skills and discipl'),(132,'Back End Developer',' handle the server-side of the website, manag'),(133,'HACKER','Hacking Bank Account'),(134,'data analyst','statistical analysis of data'),(135,'Web Developer','Designing and developing websites according to client specifications.'),(136,'Cybersecurity','skills to keep their data,including customer,'),(137,'Game designing','Ability to develop a hero in game'),(138,'UI/UX Designer','Developing visual concepts, graphics, and layouts based on client or project requirements.'),(139,'Network Configuration','assigning network settings, policies, flows, '),(140,'Wed Designer','Ability to pla, create and code internet site'),(141,'Roblox Game Designer','A game designer\'s role is to create an engagi'),(142,'Digital Forensics','Focuses on identifying, acquiring, processing'),(143,'Game Level Design ','Create structure, layout and overall experience of a game development'),(144,'Data Visualization','is the practice of designing and creating eas'),(145,'Computational Scientist','Determine computing needs and system requirem'),(146,'Technical Skills','Should have a detailed knowledge of softw'),(147,'Web developer','Create functional, user-friendly websites'),(148,'Azure API Developer','Design and build scalable and secure integration solutions using Azure Logic Apps, Azure API Management, and Microsoft Integration Services.'),(149,'Cybersecurity Master','monitor current systems for both internal and'),(150,'Technical skills',' could be responsible for providing technical support, troubleshooting hardware and software issues, and assisting with the implementation and maintenance of IT systems within an organization.'),(151,'UI Designer','Designing UI'),(152,'Back end Developer','Ability tosomething that is farthest from the'),(153,'Security Specialist','Develop and implement security measures'),(154,'Technical Skills ','Equipment repairs, installations and troubles'),(155,'Fullstack Software Engineer','Plan, Design, and Develop software'),(156,'Quantum Ciphercraft Mastery','Proficiency in Quantum Ciphercraft involves the ability to create and decode ethereal encryptions, harnessing the quantum dance of particles to fortify data against unseen digital adversaries. Masters of this skill can seamlessly traverse the realms of quantum computing, crafting cryptographic shields that defy conventional decryption methods. Quantum Ciphercraft expertise empowers individuals to safeguard information with arcane algorithms, ensuring the sanctity of digital secrets in an ever-ev'),(157,'Parallel Programming','Ability to develop multiple projects simultan'),(158,'Natural Language Processing','Expertise in machine learning models and libr'),(159,'senior level','all around hacking'),(160,'SOFTWARE TESTER','Ability to test and enhance the software'),(161,'Network Engineer','Designing and implementing new network soluti'),(162,'Front End Developer','Create and Enhance the look and feel og a UI'),(163,'Mid End Developer','Create and Innovate new design '),(164,'Threat Hunting','Proactive cybersecurity: detect, analyze, res');
...
-- Dump completed on 2023-12-26 22:45:26

...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$720000$lQHL87nWtvjroUbRYqE5kf$k+AYB7UqMVZz6e1zXotn5n4cQUxpZh/bN4DKOUMYhGU=','2023-12-26 15:37:01.780547',1,'admin','','','admin@gmail.com',1,1,'2023-12-09 08:16:05.278223');
...
INSERT INTO `project_app_employeeskills` VALUES (1,3,'Advanced Mastery'),(1,32,'Amateur'),(2,14,'Average'),(2,42,'Advanced'),(3,4,'Advanced'),(3,15,'Advanced'),(4,17,'Beginner'),(4,50,'Advanced'),(4,51,'Advanced'),(5,32,'Advanced'),(6,6,'Intermediate'),(6,13,'Advanced'),(7,9,'Beginner'),(8,10,'Beginner'),(8,31,'Advanced'),(9,11,'Mid-level'),(11,1,'Advanced'),(12,16,'Professional'),(13,13,'Expert'),(14,31,'Professional'),(15,17,'Intermediate'),(16,8,'Expert'),(16,45,'Advanced'),(17,15,'Professional'),(17,32,'Professional'),(18,20,'Average'),(19,20,'Average'),(20,45,'Advanced Mastery'),(21,23,'Expert'),(22,14,'Advanced'),(22,16,'Amateur'),(23,21,'Expert'),(24,25,'Expert'),(25,26,'Expert'),(26,11,'Professional'),(27,32,'Professional'),(28,23,'Beginner'),(29,13,'Professional'),(30,33,'Professional'),(31,18,'Legendary'),(31,44,'Master Level'),(32,11,'Advanced'),(32,36,'Professional'),(33,33,'Professional'),(34,41,'Advanced'),(35,12,'Beginner'),(35,33,'Professional'),(36,35,'Expert'),(37,14,'Intermediate'),(38,22,'Professional'),(39,11,'Amateur'),(40,35,'Average'),(41,31,'Professional'),(41,32,'Advanced'),(42,44,'Advanced'),(42,50,'Intermediate'),(43,20,'Average'),(44,14,'Expert'),(45,41,'Expert'),(46,44,'Proffesional'),(47,13,'Intermediate'),(48,32,'Professional'),(49,23,'Advanced'),(50,16,'Expert'),(51,17,'Master Level'),(51,20,'Amateur'),(52,30,'Beginner'),(53,40,'Professional'),(54,22,'Ibang Level'),(55,31,'Professional'),(56,24,'Intermediate'),(57,16,'Intermediate  '),(58,17,'Professional'),(59,23,'Professional'),(60,27,'Intermediate'),(61,27,'Intermediate'),(62,1,'Advanced Mastery'),(63,6,'Professional'),(64,8,'Professional'),(65,10,'Professional'),(66,10,'Intermediate'),(67,29,'Professional'),(68,25,'Advance Mastery'),(69,43,'Ace'),(70,33,'Professional'),(71,4,'Professional'),(72,38,'Professional'),(73,37,'Non Professional'),(74,15,'Professional'),(75,1,'Professonal'),(76,32,'Professional'),(77,37,'Advanced 2'),(78,0,'Professional'),(79,1,'Beginner'),(80,5,'Mythical Glory'),(81,32,'Professional'),(82,33,'Entry Level'),(83,23,'Professional'),(84,27,'Professional'),(85,28,'Professional'),(86,25,'Professional'),(87,16,'Professional'),(88,38,'Advanced'),(89,3,'Professional'),(90,12,'Professional'),(91,33,'Advance'),(92,41,'Average'),(93,39,'Entry-level'),(94,41,'Professional'),(95,46,'Professional'),(96,27,'LEVEL 1'),(97,41,'High'),(98,14,'Newbie'),(99,18,'Professional'),(100,40,'SUPER SAIYAN'),(101,36,'Amateur'),(102,47,'Average'),(103,27,'Professional'),(104,44,'Average'),(105,44,'Average'),(106,27,'Professional'),(107,23,'Average'),(108,11,'Advanced'),(109,1,'Amateur'),(110,48,'Professional'),(111,38,'Advanced'),(112,10,'Amateur'),(113,27,'Professional'),(114,23,'Amateur'),(115,30,'Advanced'),(116,2,'Professional'),(117,42,'Amateur'),(118,31,'Advanced'),(119,46,'Master Level'),(120,32,'Professional'),(121,11,'Advanced'),(122,8,'Advanced'),(123,11,'Professional'),(124,19,'Master Level'),(125,29,'Advanced'),(126,11,'Advanced'),(127,18,'Amateur'),(128,26,'Professional'),(129,1,'Professional'),(130,31,'Professional'),(131,17,'Amateur'),(132,41,'Amateur'),(133,32,'Intermediate'),(134,37,'Professional'),(135,39,'Advanced'),(136,40,'Advanced'),(137,30,'Professional'),(138,10,'Intermediate'),(139,11,'Beginner'),(140,44,'Beginner'),(141,43,'Advance Mastery'),(142,20,'Intermediate'),(143,13,'Professional'),(144,40,'Advanced'),(145,16,'Professional'),(146,16,'Intermediate'),(147,23,'Amateur'),(148,27,'Master Level'),(149,16,'Amateur'),(150,23,'Beginner'),(151,25,'Professional'),(152,12,'Master Level'),(153,1,'Master Level'),(154,30,'Professional'),(155,5,'Master Level'),(156,5,'Professional'),(157,19,'Advanced'),(158,42,'Amateur'),(159,3,'Intermediate'),(160,10,'Intermediate'),(161,15,'Amateur'),(162,33,'Advanced'),(163,49,'Amateur'),(164,51,'Advanced'),(165,31,'Beginner'),(166,2,'Advanced');
...
--
-- Table structure for table `project_app_project`
--

DROP TABLE IF EXISTS `project_app_project`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `project_app_project` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `project_app_project`
--

LOCK TABLES `project_app_project` WRITE;
/*!40000 ALTER TABLE `project_app_project` DISABLE KEYS */;
INSERT INTO `project_app_project` VALUES (14,'SecureChat','SecureChat is a cutting-edge project in the field of computer science that aims to develop a highly secure and privacy-focused instant messaging application. In a world where digital communication is prevalent, privacy and security have become critical concerns. SecureChat addresses these concerns by implementing state-of-the-art encryption techniques and robust security measures to ensure user data remains confidential.','2023-12-16','2023-12-31'),(15,'SecureChat','SecureChat is a cutting-edge project in the field of computer science that aims to develop a highly secure and privacy-focused instant messaging application. In a world where digital communication is prevalent, privacy and security have become critical concerns. SecureChat addresses these concerns by implementing state-of-the-art encryption techniques and robust security measures to ensure user data remains confidential.','2023-12-16','2023-12-31'),(16,'SecureChat','SecureChat is a cutting-edge project in the field of computer science that aims to develop a highly secure and privacy-focused instant messaging application. In a world where digital communication is prevalent, privacy and security have become critical concerns. SecureChat addresses these concerns by implementing state-of-the-art encryption techniques and robust security measures to ensure user data remains confidential.','2023-12-16','2023-12-31'),(17,'SecureChat','SecureChat is a cutting-edge project in the field of computer science that aims to develop a highly secure and privacy-focused instant messaging application. In a world where digital communication is prevalent, privacy and security have become critical concerns. SecureChat addresses these concerns by implementing state-of-the-art encryption techniques and robust security measures to ensure user data remains confidential.','2023-12-16','2023-12-31');
/*!40000 ALTER TABLE `project_app_project` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `project_app_project_preferred_hobbies`
--

DROP TABLE IF EXISTS `project_app_project_preferred_hobbies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `project_app_project_preferred_hobbies` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `project_id` bigint NOT NULL,
  `hobby_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `project_app_project__hobby_id_1b29008e_fk_project_a_idx` (`hobby_id`),
  KEY `project_app_project_preferred_hobbies_fk_project_idx` (`project_id`),
  CONSTRAINT `project_app_project__hobby_id_1b29008e_fk_project_a` FOREIGN KEY (`hobby_id`) REFERENCES `project_app_hobby` (`id`),
  CONSTRAINT `project_app_project_preferred_hobbies_fk_project` FOREIGN KEY (`project_id`) REFERENCES `project_app_project` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `project_app_project_preferred_hobbies`
--

LOCK TABLES `project_app_project_preferred_hobbies` WRITE;
/*!40000 ALTER TABLE `project_app_project_preferred_hobbies` DISABLE KEYS */;
INSERT INTO `project_app_project_preferred_hobbies` VALUES (21,16,1),(22,16,3),(23,16,13),(24,16,9),(25,17,11),(26,17,2),(27,17,11),(28,17,8),(29,14,12),(30,14,10),(31,14,13);
/*!40000 ALTER TABLE `project_app_project_preferred_hobbies` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `project_app_project_preferred_personalities`
--

DROP TABLE IF EXISTS `project_app_project_preferred_personalities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `project_app_project_preferred_personalities` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `project_id` bigint NOT NULL,
  `personality_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `project_app_project_preferred_personalities_fk_project_idx` (`project_id`),
  KEY `project_app_project_preferred_personalities_fk_personalitie_idx` (`personality_id`),
  CONSTRAINT `project_app_project_preferred_personalities_fk_personalities` FOREIGN KEY (`personality_id`) REFERENCES `project_app_personality` (`id`),
  CONSTRAINT `project_app_project_preferred_personalities_fk_project` FOREIGN KEY (`project_id`) REFERENCES `project_app_project` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `project_app_project_preferred_personalities`
--

LOCK TABLES `project_app_project_preferred_personalities` WRITE;
/*!40000 ALTER TABLE `project_app_project_preferred_personalities` DISABLE KEYS */;
INSERT INTO `project_app_project_preferred_personalities` VALUES (6,16,7),(7,16,4),(8,16,5),(9,16,6),(10,17,16),(11,17,15),(12,17,4),(13,14,4),(14,14,10);
/*!40000 ALTER TABLE `project_app_project_preferred_personalities` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `project_app_project_required_skills`
--

DROP TABLE IF EXISTS `project_app_project_required_skills`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `project_app_project_required_skills` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `project_id` bigint NOT NULL,
  `skill_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `project_app_project_fk_project_idx` (`project_id`),
  KEY `project_app_project_required_skills_fk_skill_idx` (`skill_id`),
  KEY `project_app_project_required_skills_fk_skills_idx` (`skill_id`),
  CONSTRAINT `project_app_project_fk_project` FOREIGN KEY (`project_id`) REFERENCES `project_app_project` (`id`),
  CONSTRAINT `project_app_project_required_skills_fk_skills` FOREIGN KEY (`skill_id`) REFERENCES `project_app_skill` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `project_app_project_required_skills`
--

LOCK TABLES `project_app_project_required_skills` WRITE;
/*!40000 ALTER TABLE `project_app_project_required_skills` DISABLE KEYS */;
INSERT INTO `project_app_project_required_skills` VALUES (33,14,48),(34,14,42),(35,15,48),(36,15,42),(37,16,49),(38,16,37),(39,16,3),(40,16,4),(41,16,47),(42,17,49),(43,17,1),(44,17,22),(45,17,46),(46,14,20),(47,14,6);
/*!40000 ALTER TABLE `project_app_project_required_skills` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-12-27  2:41:09

...
--
-- Table structure for table `project_app_employeeskilllevel`
--

DROP TABLE IF EXISTS `project_app_employeeskilllevel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `project_app_employeeskilllevel` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `project_app_employeeskilllevel`
--

LOCK TABLES `project_app_employeeskilllevel` WRITE;
/*!40000 ALTER TABLE `project_app_employeeskilllevel` DISABLE KEYS */;
INSERT INTO `project_app_employeeskilllevel` VALUES (1,'Beginner'),(2,'Intermediate'),(3,'Advanced'),(4,'Professional');
/*!40000 ALTER TABLE `project_app_employeeskilllevel` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `project_app_employeeskills` (
  ...
  KEY `project_app_employeeskills_fk_employeeskilllevel_idx` (`skill_id`),
  KEY `project_app_employeeskills_idx` (`skill_level_id`),
  CONSTRAINT `project_app_employeeskills_employees` FOREIGN KEY (`employee_id`) REFERENCES `project_app_employees` (`id`),
  CONSTRAINT `project_app_employeeskills_fk_employeeskilllevel` FOREIGN KEY (`skill_level_id`) REFERENCES `project_app_employeeskilllevel` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `project_app_employeeskills` VALUES (1,3,1),(3,15,1),(6,13,1),(9,11,1),(21,23,1),(22,14,1),(23,21,1),(31,44,1),(35,12,1),(38,22,1),(47,13,1),(49,23,1),(50,16,1),(51,17,1),(67,29,1),(76,32,1),(77,37,1),(86,25,1),(95,46,1),(103,27,1),(115,30,1),(118,31,1),(119,46,1),(122,8,1),(126,11,1),(134,37,1),(146,16,1),(152,12,1),(162,33,1),(163,49,1),(2,42,2),(4,17,2),(6,6,2),(8,10,2),(11,1,2),(13,13,2),(14,31,2),(15,17,2),(18,20,2),(20,45,2),(22,16,2),(29,13,2),(31,18,2),(32,11,2),(34,41,2),(36,35,2),(39,11,2),(42,44,2),(42,50,2),(43,20,2),(48,32,2),(51,20,2),(52,30,2),(53,40,2),(54,22,2),(64,8,2),(66,10,2),(68,25,2),(73,37,2),(74,15,2),(75,1,2),(78,1,2),(79,1,2),(80,5,2),(83,23,2),(84,27,2),(85,28,2),(88,38,2),(89,3,2),(90,12,2),(91,33,2),(92,41,2),(94,41,2),(98,14,2),(102,47,2),(104,44,2),(106,27,2),(107,23,2),(108,11,2),(114,23,2),(116,2,2),(117,42,2),(121,11,2),(123,11,2),(125,29,2),(127,18,2),(130,31,2),(133,32,2),(135,39,2),(139,11,2),(143,13,2),(145,16,2),(147,23,2),(148,27,2),(149,16,2),(150,23,2),(151,25,2),(154,30,2),(157,19,2),(158,42,2),(159,3,2),(164,51,2),(165,31,2),(166,2,2),(2,14,3),(4,51,3),(8,31,3),(17,32,3),(19,20,3),(24,25,3),(25,26,3),(28,23,3),(30,33,3),(32,36,3),(35,33,3),(37,14,3),(40,35,3),(44,14,3),(55,31,3),(56,24,3),(57,16,3),(58,17,3),(65,10,3),(69,43,3),(70,33,3),(71,4,3),(72,38,3),(81,32,3),(82,33,3),(87,16,3),(93,39,3),(99,18,3),(100,40,3),(101,36,3),(105,44,3),(109,1,3),(110,48,3),(120,32,3),(124,19,3),(128,26,3),(131,17,3),(136,40,3),(137,30,3),(138,10,3),(153,1,3),(155,5,3),(156,5,3),(160,10,3),(1,32,4),(3,4,4),(4,50,4),(5,32,4),(7,9,4),(12,16,4),(16,8,4),(16,45,4),(17,15,4),(26,11,4),(27,32,4),(33,33,4),(41,31,4),(41,32,4),(45,41,4),(46,44,4),(59,23,4),(60,27,4),(61,27,4),(62,1,4),(63,6,4),(96,27,4),(97,41,4),(111,38,4),(112,10,4),(113,27,4),(129,1,4),(132,41,4),(140,44,4),(141,43,4),(142,20,4),(144,40,4),(161,15,4);
...
-- Dump completed on 2023-12-27 16:00:07
